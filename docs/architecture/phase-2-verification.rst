...
.. list-table:: Compatibility and evidence matrix
   ...
   * - ``Divider`` and ``StatusBadge``
     - `Issue #12 <https://github.com/TheBitPoets/utui/issues/12>`__ /
       `PR #13 <https://github.com/TheBitPoets/utui/pull/13>`__
     - :doc:`API reference <../api/index>` (``docs/api/index.rst``)
     - :doc:`User guide <../user-guide/index>` (``docs/user-guide/index.rst``);
       `example <https://github.com/TheBitPoets/utui/blob/master/examples/divider_badges.py>`__
       (``examples/divider_badges.py``)
     - Not needed: exact text snapshots carry the visual contract
     - `Snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_divider_status_badge.py>`__
       (``tests/test_divider_status_badge.py``)
   * - ``ListView``
     - `Issue #14 <https://github.com/TheBitPoets/utui/issues/14>`__ /
       `PR #15 <https://github.com/TheBitPoets/utui/pull/15>`__
     - :doc:`API reference <../api/index>` (``docs/api/index.rst``)
     - :doc:`User guide <../user-guide/index>` (``docs/user-guide/index.rst``);
       `example <https://github.com/TheBitPoets/utui/blob/master/examples/selectable_list.py>`__
       (``examples/selectable_list.py``)
     - `SVG <https://github.com/TheBitPoets/utui/blob/master/docs/_static/images/selectable-list.svg>`__
       (``docs/_static/images/selectable-list.svg``)
     - `Snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_list_view.py>`__
       (``tests/test_list_view.py``)
   * - ``Canvas.blit`` and ``ScrollView``
     - `Issue #16 <https://github.com/TheBitPoets/utui/issues/16>`__ /
       `PR #17 <https://github.com/TheBitPoets/utui/pull/17>`__
     - :doc:`API reference <../api/index>` (``docs/api/index.rst``)
     - :doc:`User guide <../user-guide/index>` (``docs/user-guide/index.rst``);
       `example <https://github.com/TheBitPoets/utui/blob/master/examples/scroll_view.py>`__
       (``examples/scroll_view.py``)
     - `SVG <https://github.com/TheBitPoets/utui/blob/master/docs/_static/images/scroll-view.svg>`__
       (``docs/_static/images/scroll-view.svg``)
     - `Canvas snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_canvas.py>`__
       (``tests/test_canvas.py``);
       `viewport snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_scroll_view.py>`__
       (``tests/test_scroll_view.py``)
   * - ``Modal``
     - `Issue #18 <https://github.com/TheBitPoets/utui/issues/18>`__ /
       `PR #19 <https://github.com/TheBitPoets/utui/pull/19>`__
     - :doc:`API reference <../api/index>` (``docs/api/index.rst``)
     - :doc:`User guide <../user-guide/index>` (``docs/user-guide/index.rst``);
       `example <https://github.com/TheBitPoets/utui/blob/master/examples/modal.py>`__
       (``examples/modal.py``)
     - `SVG <https://github.com/TheBitPoets/utui/blob/master/docs/_static/images/modal.svg>`__
       (``docs/_static/images/modal.svg``)
     - `Snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_modal.py>`__
       (``tests/test_modal.py``)
   * - Responsive ``Row`` / ``Column`` baseline
     - Phase 1 baseline
     - :doc:`API reference <../api/index>` (``docs/api/index.rst``)
     - :doc:`User guide <../user-guide/index>` (``docs/user-guide/index.rst``);
       `example <https://github.com/TheBitPoets/utui/blob/master/examples/basic_panels.py>`__
       (``examples/basic_panels.py``)
     - `Wide SVG <https://github.com/TheBitPoets/utui/blob/master/docs/_static/images/three-panels-wide.svg>`__
       (``docs/_static/images/three-panels-wide.svg``);
       `narrow SVG <https://github.com/TheBitPoets/utui/blob/master/docs/_static/images/three-panels-narrow.svg>`__
       (``docs/_static/images/three-panels-narrow.svg``)
     - `Layout snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_layout.py>`__
       (``tests/test_layout.py``);
       `renderer snapshots <https://github.com/TheBitPoets/utui/blob/master/tests/test_renderer.py>`__
